...
class BernoulliMixture:
    ...
    def run_EM(self, tol, min_probability=0.05, debug_plot=False, hard_assignment=False):
        """
    ...
    def _compute_loglikelihoods(self):
        ...
        if self.hard_assignment:
            self.affinities[:] = 0
            self.affinities[np.arange(self.num_data),
                            np.argmax(template_logscores,1)] = 1
