...
output = open('data_iter050912.pkl','wb')
...
output = open('all_patterns050912.pkl','wb')
cPickle.dump(all_patterns,output)
output.close()

output = open('all_patterns_context050912.pkl','wb')
...
np.save('mean_template050912',mean_template)
np.save('template_shape050912',template_shape)
...
for p in xrange(len(all_patterns)):
   print all_patterns_context[p].shape[1] - all_patterns[p].shape[1]
